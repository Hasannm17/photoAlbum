...
regiterActivityForSelectImage();
        imageViewAddImage =findViewById(R.id.imageViewUpdate);

        editTextAddTitle=findViewById(R.id.editTexttitleUpdate);
        editTextAddDescription=findViewById(R.id.editTextTextMultiLineUpdate);
